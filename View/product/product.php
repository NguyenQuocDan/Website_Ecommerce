			...
			<div class="row details_row">
				...
				<div class="col-lg-6">
					<div class="details_image">
						<div class="details_image_large"><img src="<?php echo $product->getImage()?>" alt=""><div class="product_extra product_new"><a href="../categories.html">New</a></div></div>
...
<!--						</div>-->
				...
				<div class="col-lg-6">
					<div class="details_content">
						<div class="details_name"><?php echo $product->getname()?></div>
						<div class="details_price"><?php echo $product->getPrice()?></div>
			...
			<div class="row description_row">
				<div class="col">
					<div class="description_title_container">
						<div class="description_title"><?php echo $product->getDesc()?>?</div>
