<div class="menu menu_mm trans_300">
    <div class="menu_container menu_mm">
        <div class="page_menu_content">
            ...
            <ul class="page_menu_nav menu_mm">THU NGÂN 					<li class="page_menu_item has-children menu_mm">
                ...
                <li class="page_menu_item has-children menu_mm">
                    <a href="View/categories.html">Categories<i class="fa fa-angle-down"></i></a>
                    <ul class="page_menu_selection menu_mm">
                        <li class="page_menu_item menu_mm"><a href="View/categories.html">Category<i class="fa fa-angle-down"></i></a></li>
                        <li class="page_menu_item menu_mm"><a href="View/categories.html">Category<i class="fa fa-angle-down"></i></a></li>
                        <li class="page_menu_item menu_mm"><a href="View/categories.html">Category<i class="fa fa-angle-down"></i></a></li>
                        <li class="page_menu_item menu_mm"><a href="View/categories.html">Category<i class="fa fa-angle-down"></i></a></li>
                    </ul>
